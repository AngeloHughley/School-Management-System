...
public class EditTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Teacher's Info");
        ...
        jLabel12.setText("Subject Taught:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String phone = primaryPhone.getText();
        ...
        try{
            ...
            String sql = "update `teacher_info` SET `SubjectTaught`='"+sub+"',`Address`='"+tAddress+"',`TeacherName`='"+name+"',`PhoneNumber`='"+phone+"'WHERE TeacherID = '"+id+"'";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.execute();
            JOptionPane.showMessageDialog(null, "Teacher has been updated.");
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null, "Error with editing the teacher.");
        }
